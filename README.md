...
All you need to spend time on a desert island.

### Best ZX-SPECTRUM emulators

|Host OS|Emulator|Last updated|
|---|---|---|
|Windows|[**unrealspeccy** v0.39](https://github.com/mkoloberdin/unrealspeccy)|2019|
|Crossplatform|[**USP** v0.38 - unrealspeccy portable fork](https://bitbucket.org/djdron/unrealspeccyp)|2018|
|Crossplatform|[**Fuse** emulator v1.5.7](http://fuse-emulator.sourceforge.net)|2018|
|DOS| **x128** v0.94 by James McKay | 2002 |
|DOS| **r80** v0.30 by Raul Gomez Sanchez | 2000 |
|DOS| **Shalaev** v3.05 by Nikolay Shalaev | 1999 |
